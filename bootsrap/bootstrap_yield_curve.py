...
class BootstrapYieldCurve():
    ...
    def get_maturities_zero_rates(self):
        """ Dict of maturities and zero rates """
        self.__bootstrap_zero_coupons__()
        self.__get_bond_spot_rates__()
        return {T : self.zero_rates[T] for T in self.get_maturities()}
    ...
    def __calculate_bond_spot_rate__(self, T, instrument):
        ...
        try:
            ...
            return spot_rate
               ...
               raise(f"Error: spot rate not found for T = {t}")
